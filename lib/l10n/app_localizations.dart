...
class AppLocalizations {
  ...
  String get consentSubtitle => _t(en: 'ETH Zurich — Digital Health Group', de: 'ETH Zürich — Digitale Gesundheitsgruppe', tr: 'ETH Zürih — Dijital Sağlık Grubu', es: 'ETH Zúrich — Grupo de Salud Digital', it: 'ETH Zurigo — Gruppo Salute Digitale', fr: 'ETH Zurich — Groupe Santé Numérique', zh: '苏黎世联邦理工学院 — 数字健康组', ja: 'ETHチューリッヒ — デジタルヘルスグループ', ko: 'ETH 취리히 — 디지털 헬스 그룹', ar: 'معهد ETH زيورخ — مجموعة الصحة الرقمية', ru: 'ЕТВ Цюрих — Группа цифрового здоровья');
  ...
  String get consentContactBody => _t(en: 'Digital Health Group\nETH Zurich\ndigital-health@ethz.ch', de: 'Digitale Gesundheitsgruppe\nETH Zürich\ndigital-health@ethz.ch', tr: 'Dijital Sağlık Grubu\nETH Zürih\ndigital-health@ethz.ch', es: 'Grupo de Salud Digital\nETH Zúrich\ndigital-health@ethz.ch', it: 'Gruppo Salute Digitale\nETH Zurigo\ndigital-health@ethz.ch', fr: 'Groupe Santé Numérique\nETH Zurich\ndigital-health@ethz.ch', zh: '数字健康组\n苏黎世联邦理工学院\ndigital-health@ethz.ch', ja: 'デジタルヘルスグループ\nETHチューリッヒ\ndigital-health@ethz.ch', ko: '디지털 헬스 그룹\nETH 취리히\ndigital-health@ethz.ch', ar: 'مجموعة الصحة الرقمية\nمعهد ETH زيورخ\ndigital-health@ethz.ch', ru: 'Группа цифрового здоровья\nЕТВ Цюрих\ndigital-health@ethz.ch');
